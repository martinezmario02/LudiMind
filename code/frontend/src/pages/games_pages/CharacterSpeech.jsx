...
export default function CharacterSpeech({ text, image, showAvatar = true }) {
  return (
    <div className="flex flex-col items-center justify-center space-y-8 py-10 mt-10">
      ...
      {/* Avatar */}
      {showAvatar && (
        <motion.img src={image} alt="Avatar" className="w-48 h-48 object-contain drop-shadow-lg" initial={{ scale: 0.7, opacity: 0 }}
