...
function DraggableObject({ obj }) {
    ...
    return (
        <div
            ref={dragRef}
            className={`flex-shrink-0 w-32 h-32 bg-white rounded-lg shadow-lg flex flex-col items-center justify-center cursor-move transition ${isDragging ? "opacity-50 scale-95" : "opacity-100"
                }`}
        >
