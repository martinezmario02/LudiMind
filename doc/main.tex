...
Con el propósito de proporcionar una herramienta lúdica y educativa que favorezca la mejora de estas funciones ejecutivas, en este Trabajo de Fin de Máster se ha creado una plataforma digital de minijuegos educativos enfocada en niños y niñas con TDAH. 
...
Para el desarrollo de la plataforma, se ha utilizado React.js para el frontend y Node.js con Express para el backend, asegurando una experiencia de usuario fluida y accesible desde múltiples dispositivos. Además, se ha levantado en contendores Docker para facilitar su despliegue y mantenimiento.
