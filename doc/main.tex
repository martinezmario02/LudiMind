...
\begin{titlepage}
    ...
    {\LARGE \textit{Sistema de estimulación cognitiva mediante juegos interactivos para niños con TDAH} \par}
...
Las personas que padecen Trastorno por Déficit de Atención e Hiperactividad (TDAH) enfrentan diariamente retos relacionados con la autorregulación, la impulsividad, la concentración y la planificación. Estas limitaciones pueden impactar el desarrollo académico, social y emocional de los estudiantes, especialmente si no se aplican estrategias de intervención adecuadas.

Con el propósito de proporcionar una herramienta lúdica y educativa que favorezca la mejora de estas funciones ejecutivas, en este Trabajo de Fin de Máster se ha creado una plataforma digital de minijuegos educativos enfocada en niños y niñas con TDAH. La aplicación tiene como objetivo estimular habilidades fundamentales como la memoria de trabajo o la planificación, utilizando dinámicas motivadoras, refuerzo positivo y un diseño adaptado a sus necesidades cognitivas.
...
TDAH, Funciones ejecutivas, Juegos educativos, Atención, Motivación, Plataforma digital, Memoria de trabajo, Planificación, Autorregulación emocional, Resolución de conflictos, Estudiantes, Usabilidad, Gamificación, Refuerzo positivo, Evaluación.
\newpage
...
People with Attention Deficit Hyperactivity Disorder (ADHD) face daily challenges related to self-regulation, impulsivity, concentration, and planning. These limitations can impact students' academic, social, and emotional development, especially if appropriate intervention strategies are not implemented.
...
ADHD, Executive Functions, Educational Games, Attention, Motivation, Digital Platform, Working Memory, Planning, Emotional Self-Regulation, Conflict Resolution, Students, Usability, Gamification, Positive Reinforcement, Assessment.
\newpage
...
\newpage
\input{secciones/3_analisis}

\newpage
\input{secciones/4_propuesta}

\newpage
\input{secciones/5_mecanicajuegos}
