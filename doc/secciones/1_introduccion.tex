...
El Trastorno por Déficit de Atención e Hiperactividad, en adelante TDAH, es una afección crónica que experimentan millones de niños y niñas, continuando en muchos casos en la edad adulta. 
...
De esta forma, escogí este proyecto no solo en busca de ayudar a estas personas a mejorar diversas habilidades y a sus terapeutas con el seguimiento, sino que también tratando de buscar una mayor conciencia y comprensión de la población sobre el TDAH, promoviendo un enfoque más inclusivo hacia las personas que viven esta condición diariamente.
...
Esto se vio reforzado por mi experiencia previa trabajando con niños y  niñas con TDAH durante el desarrollo de mi Trabajo de Fin de Grado, donde pude profundizar en sus necesidades al desarrollar otra aplicación para este colectivo. 
...
Para ello, la aplicación contará con varios minijuegos con distintos niveles, los cuales fomenten el desarrollo de habilidades como la memoria, la organización, la resolución de conflictos o la gestión del tiempo.

\newpage

\subsection{Objetivos del proyecto}
Este proyecto se plantea como una aplicación lúdica y educativa destinada a estudiantes con TDAH con una edad comprendida entre los 9 y los 17 años aproximadamente, con el fin de apoyar el desarrollo de sus habilidades cognitivas, tales como la atención, la memoria de trabajo, la planificación, la gestión del tiempo y la supervisión de la acción.
...
\begin{enumerate}
    ...
    \item Revisar trabajos de investigación relacionados para aprender de ellos.
    \item Desarrollar una aplicación con interfaz accesible, atractiva y adaptada a la población con TDAH.
    \item Diseñar minijuegos para esa aplicación con distintas mecánicas que trabajen áreas concretas como la memoria, la organización o la resolución de conflictos sociales.
    ...
    \item Evaluar la aplicación con perfiles representativos del público objetivo, ya sean estudiantes, familias o profesores.
\end{enumerate}
...
En este apartado se describe la organización del presente documento, detallando de forma resumida el contenido que se abordará en cada sección. 
La finalidad de esta estructura es ofrecer al lector una visión clara y ordenada del desarrollo del trabajo, facilitando la localización de la información y la comprensión.
...
\begin{itemize}
    ...
    \item \textbf{Propuesta}: define la solución planteada mostrando, iteración a iteración, el trabajo realizado.
    \item \textbf{Evaluación con usuarios}: describe el proceso de evaluación llevado a cabo con usuarios representativos del público objetivo, incluyendo la metodología, los resultados obtenidos y el análisis de los mismos.
    \item \textbf{Conclusiones y trabajo futuro}: resume los hallazgos principales del proyecto, reflexiona sobre los objetivos alcanzados y propone posibles líneas de trabajo futuro para continuar mejorando la aplicación.
