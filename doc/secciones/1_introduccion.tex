...
\begin{enumerate}
    ...
    \item Evaluar la plataforma con perfiles representativos del público objetivo, ya sean estudiantes, familias o profesores.
\end{enumerate}
