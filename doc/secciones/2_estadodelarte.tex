...
De este modo, se plantea como proyecto la implementación de una aplicación de minijuegos que pueda incorporarse al proyecto \textit{DiverAccion}, el cual pretende mejorar habilidades como la memoria, planificación, organización y gestión del tiempo en adolescentes con diagnóstico de TDAH, entre 9 y 17 años. 
...
El juego \textit{Jumpy Car ADHD} \parencite{jumpycaradhd} es una aplicación diseñada para mejorar la atención sostenida, la impulsividad y la capacidad de planificación en niños y niñas con TDAH. 
...
El diseño del entorno, colorido y con niveles progresivos, busca equilibrar el desafío y la accesibilidad, adaptándose a distintos niveles de rendimiento.
...
En este sentido, algunos juegos de la aplicación \textit{Lumosity} como \textit{Memory Matrix} estimulan la retención activa de patrones o secuencias visuales, reforzando la memoria de trabajo. 
...
Esta tercera aplicación \parencite{cognifit} es una aplicación de estimulación cognitiva basada en la neuropsicología y en la evaluación del rendimiento, permitiendo tanto la estimulación como el seguimiento personalizado.
...
A continuación, se muestra un minijuego en el que la aplicación muestra un número al usuario durante un segundo y éste tiene que recordarlo.
...
\newpage
A continuación, se muestra una tabla comparativa que resume los aspectos clave de los artículos científicos revisados:
