...
Por otro lado, diversos estudios científicos han evaluado la eficacia de esta plataforma, analizando el impacto real en personas adultas con TDAH \parencite{lumosity_tdah}.
...
Para la evaluación se utilizan instrumentos que podrían ser útiles para la validación de la plataforma a desarrollar en este proyecto. 
...
Entre dichos programas podemos destacar \textit{Computerized Progressive Attentional Training (CPAT)}, el cual está compuesto por cuatro conjuntos de tareas estructuradas que activan de forma única la atención sostenida, la atención selectiva, la orientación de la atención y la atención ejecutiva \parencite{cpat}.
Como resultado, se observó cómo los participantes mejoraban de forma significativa en la comprensión lectora, reduciendo también el número de informes de los padres sobre la falta de atención.
...
Respecto al neurofeedback, se trata de una técnica para entrenar el cerebro, ta sea para mejorar el rendimiento del usuario o para corregir alguna dificultad o trastorno que pueda estar causando un desequilibrio en el funcionamiento cerebral \parencite{neurofeedback}.

Así pues, al igual que en el estudio anterior, este estudio destaca el uso de plataformas gamificadas o entornos lúdicos, lo que potencia la implicación del alumnado y contribuye a la mejora en medidas clínicas y funcionales.

Además, se han estudiado otros tres artículos relacionados con los juegos serios.
Por un lado, encontramos \textit{A Review on Serious Games for ADHD} \parencite{games_adhd_2021}, el cual ofrece una revisión exhaustiva de los juegos serios en distintos ámbitos, como la salud o la educación.
...
Así pues, se consluye que tanto las terapias digitales como los juegos serios pueden mejorar la funciones cognitivas, pudiendo emplear protocolos estandarizados, como PRISMA o Cochrane, y herramientas de evaluación validadas, como ADHD-RS o BRIEF-2.
...
En definitiva, estos artículos proporcionan una base sólida para el desarrollo de la plataforma de minijuegos propuesta en este proyecto, orientada a mejorar habilidades cognitivas y emocionales en estudiantes con TDAH.