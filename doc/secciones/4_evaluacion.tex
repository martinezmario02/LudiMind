...
\begin{enumerate}
    ...
    \item Juego de un nivel de cada uno de los minijuegos por parte de los participantes, observando y registrando su comportamiento.
    \item Rellenado del cuestionario TAM por parte de los participantes.
\end{enumerate}
