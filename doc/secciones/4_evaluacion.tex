...
Una de mis tutoras del proyecto, Dulce, facilitó el reclutamiento de los sujetos de ambos grupos, gracias a su experiencia y contactos en el ámbito de la salud y la educación.

En estas pruebas se les pidió a los participantes que jugaran a un nivel de cada uno de los minijuegos desarrollados.
Durante la sesión, estábamos presentes únicamente el estudiante y yo, recogiendo datos sobre el uso de los juegos: el tiempo empleado para cada nivel, los errores cometidos, las dudas planteadas, las estrategias utilizadas por los jugadores y jugadoras y, finalmente, los resultados obtenidos.

De cara a la retroalimentación, se planteó el desarrollo tanto de un cuestionario SUS (System Usability Scale) \parencite{sus}, como de un cuestionario TAM (Technology Acceptance Model) \parencite{tam}, ambos adaptados al contexto de los juegos serios.
Por un lado, el cuestionario SUS se suministra a los usuarios que utilizan la aplicación (con una experiencia directa), idealmente inmediatamente después de utilizarla para que puedan evaluar su experiencia de uso de manera inmediata y precisa.
...
Se ha utilizado en muchas investigaciones, ante diversos contextos y ha demostrado ser una herramienta confiable para conocer la aceptación de estas tecnologías.
...
A esto se le sumó la observación de la corta duración de las sesiones, por lo que se optó por realizar un único cuestionario TAM, añadiendo preguntas de los cuestionarios SUS, que eran exclusivas de este cuestionario \cref{fig:tam}.
El cuestionario final incluyó las siguientes dimensiones:
...
Así pues, durante todas las sesiones de evaluación, se siguió el mismo protocolo:
\begin{enumerate}
    \item Explicación del objetivo de la evaluación y del funcionamiento general de los minijuegos.
    \item Juego de un nivel de cada uno de los minijuegos por parte de los participantes de forma individual, mientras se observaba y registraba su comportamiento.
    \item Rellenado del cuestionario TAM por parte de los participantes, así como un consentimiento informado, que cuenta con una participación voluntaria y anónima.
\end{enumerate}
...
Además, se buscaba la detección de posibles errores o dificultades en la interacción con los minijuegos, encontrando posibles mejoras.

Durante la evaluación, se contó con la participación de únicamente 6 estudiantes de bachillerato, 2 niñas y 4 niños,todos ellos con 16 años.
...
Respecto a los puntos obtenidos en cada minijuego \cref{fig:ncg_points_table}, \cref{fig:ncg_points_graph}, se observó que los participantes lograron puntajes altos en la mayoría de los niveles, lo que indica que, generalmente, las mecánicas de juego eran accesibles y comprensibles.
...
\begin{figure}[H]
    ...
    \caption{Grupo no clínico - Puntuaciones al jugar los minijuegos (máximo: 3) - Tabla}
...
\begin{figure}[H]
    ...
    \caption{Grupo no clínico - Puntuaciones al jugar los minijuegos (máximo: 3) - Gráfico}
    \label{fig:ncg_points_graph}
\end{figure}

Se observó que la mayoría de los participantes cometieron pocos errores en los niveles de los minijuegos.
Además, en la gráfica se observa un comportamiento extraño en el cuarto estudiante, pues obtuvo una puntuación perfecta en dos de los minijuegos y una puntuación de 0 en los otros dos.
Esto podría deberse a una falta de atención o concentración durante esos juegos específicos, lo que afectó negativamente su desempeño.
A continuación, se pudieron identificar ciertos problemas específicos en algunos minijuegos:
\begin{itemize}
    ...
    De esta forma, se facilitaría la experiencia de juego y se reduciría la frustración de los jugadores, lo cual se confirmó tras implementarlo y obtener mejoras en la siguiente sesión de pruebas.
...
Respecto al tiempo empleado en completar cada nivel \cref{fig:ncg_time_table} \cref{fig:ncg_time_graphic}, se observó que los participantes tardaron tiempos muy parecidos en todos los minijuegos (entre 30 y 60 segundos aproximadamente) salvo, una vez más, en \textit{Detective emociones}, donde el tiempo medio fue considerablemente mayor (llegando a alcanzar los 3 minutos y medio).
...
Tras analizar las respuestas del cuestionario TAM, completado, por falta de tiempo, por 4 de los 6 estudiantes que realizaron las pruebas, se obtuvieron los siguientes resultados en cada una de las dimensiones evaluadas:
...
A pesar de la limitación por el número de participantes, estos resultados proporcionan información valiosa para futuras mejoras y ajustes en los minijuegos, con el fin de optimizar la experiencia del usuario y aumentar la intención de uso.
...
En esta evaluación, se contó con 3 participantes diagnosticados con TDAH, todos ellos niños, dos con 12 años y otro con 17 años.
...
\paragraph{Puntos obtenidos en los minijuegos}
Respecto a los puntos obtenidos en cada minijuego \cref{fig:cg_points_table} \cref{fig:cg_points_graphic}, se observó que los participantes lograron puntajes altos en todos los niveles (más de 2 puntos sobre 3), a excepción del último estudiante con uno de los juegos, lo que indica que las mecánicas de juego eran accesibles y comprensibles para ellos.
...
\begin{figure}[H]
    ...
    \caption{Grupo clínico - Puntuaciones al jugar los minijuegos (máximo: 3) - Tabla}
...
\begin{figure}[H]
    ...
    \caption{Grupo clínico - Puntuaciones al jugar los minijuegos (máximo: 3) - Gráfico}
...
\newpage
\paragraph{Tiempo empleado en los minijuegos}
En cuanto al tiempo empleado en completar cada nivel \cref{fig:cg_time_table} \cref{fig:cg_time_graphic}, se observó que los participantes tardaron tiempos semejantes a los del grupo no clínico en todos los minijuegos, obteniendo una media de 1 minuto y 13 segundos aproximadamente por nivel.
...
\subsubsection{Resultados del cuestionario TAM}
Tras analizar las respuestas del cuestionario TAM, las cuales fueron completadas por 2 de los 3 estudiantes que realizaron las pruebas, se obtuvieron los siguientes resultados en cada una de las dimensiones:
...
Por otro lado, respecto a las preguntas abiertas, los participantes no indicaron haber encontrado errores significativos durante su experiencia de juego.
...
En resumen, y a pesar del pequeño número de participantes en el experimento, se observa que los minijuegos pueden resultar de ayuda para los niños y niñas con TDAH, ya que lograron comprender y completar las tareas propuestas.
...
Esto podría resolverse con la incorporación de la gamificación, la cual estaba prevista para futuras versiones de los minijuegos.