...
\begin{itemize}
    ...
    Estudiante, profesor/a, padre/madre, terapeuta
\end{itemize}

\subsubsection{Preguntas del cuestionario TAM+SUS}
\begin{table}[H]
\centering
...
\hline
\end{tabularx}
\caption{Cuestionario TAM+SUS de evaluación de LudiMind}
...
\subsubsection{Consentimiento al finalizar el cuestionario}
\begin{itemize}
...
\newpage
\subsection{Acceso al proyecto}
Durante el desarrollo del proyecto, tanto el código como los ficheros Latex utilizados para la elaboración de la memoria han sido almacenados en un repositorio privado de GitHub.
Una vez finalizado el proyecto, el repositorio se ha hecho público y puede ser consultado en la siguiente dirección: \url{https://github.com/martinezmario02/LudiMind.git}